...
<html lang = "fr">
   <head>
      ...
      <title id='Title'>MOOC Pilote: graphiques de progression des �l�ves</title>
   ...
   <body>
	 ...
	 <!--  EG: changed SVG to PNG -->
      ...
      <div id = "content">
	    ...
	    -->
	       ...
	       <div><img class="langSelect" style="width:18px;height:12px" src="Ressources/icon-fr.png"> <img class="langSelect" style="width:18px;height:12px" src="Ressources/icon-en.png"></div>
               ...
               <div>					
                  <a id='aHeaderMenu' href = "admin" class="headerMenu">administrateur (r�serv�)</a>
                  <a></a>
               </div>
            </div>
         </div>
      ...
      <div id="bullePopup">
         ...
         <div>
            <a class="visuLearner" style = "width:50%;font-size:13px;">Visualisation d'un �l�ve</a>
            <select style = "background-color: red;width:120px;" onchange = "updateBulleStudentListCall()" id = "bulleStudentList">
               <option class="allLearners" value = "">Tous les �l�ves</option>
            </select>
         </div>
      ...
      <div id = "menu">
         ...
         <div class = "optionsList" id = "tutorParameters">
            <span id='ptut'>Param�tres du tuteur</span>
            <div>
               <a>Seuil des notes</a>
            ...
            <div>
               ...
               <select onchange = "changeCohorte()" id = "cohorteSelect">
                  <option class="allLearners" value = "0">Tous les �l�ves</option>
               </select>
            </div>
         </div>
         <div id = "parameters" class = "notRequired">
            <label style ="display:none"><input style = "margin-left: 22px; margin-top:15px;" type="radio" name="mode" value="grouped"> D�pil�</label>
            <label style ="display:none"><input type="radio" name="mode" value="stacked" checked> Empil�</label>
            ...
            <select style = "display : none" onchange="callDisplayDiagramme()" id="visualisationMode">
               <option value="0">Nombre d'�l�ves par exercice selon leur p�riode d'inscription</option>
               <option value="1">Nombre d'�l�ves inscrits par collecte</option>
               <option value="2">R�sultats des �l�ves par exercices</option>
               <option value="3">Nombre d'�l�ves par exercice selon leurs r�sultats</option>
               <option value="4">Progression G�n�rale</option>
               <option value="10">Bilan MOOC</option>
            </select>
            <div id = "newViewSelection" style = "display : none;">
               <label class = "radioParameterLabel">Donn�es cumul�es<input onchange = "callDisplayDiagramme()" class="shape" name="visualisationMode" value="0" type="radio" checked="true"></label>
               <label class = "radioParameterLabel">Donn�es r�parties<input onchange = "callDisplayDiagramme()" class="shape" name="visualisationMode" value="1" type="radio"></label>
               <label class = "radioParameterLabel">Progression G�n�rale<input onchange = "callDisplayDiagramme()" class="shape" name="visualisationMode" value="2" type="radio"></label>
               <label class = "radioParameterLabel">Progression G�n�rale<input onchange = "callDisplayDiagramme()" class="shape" name="visualisationMode" value="3" type="radio"></label>
               <label class = "radioParameterLabel">Progression G�n�rale<input onchange = "callDisplayDiagramme()" class="shape" name="visualisationMode" value="4" type="radio"></label>
            </div>
	       ...
	       <input id="iLO3" onchange = "callDisplayDiagramme()" class="shape" name="weekModeOption" value="0" type="radio"></input>
            ...
            <div style = "display:none;" >
               <a class="visuLearner" style = "width:50%;">Visualisation d'un �l�ve</a>
	 ...
	 <div class="tooltips headline" id="head1">Repr�sentations principales</div>
...
-->
         <div class = "tooltips tooltipsbottom block" id="screen6" data-no="6,5,2" onclick="selectScreen(this)"> <!-- Nombre d'�l�ves par exercice selon leurs r�sultats // Qualit� des r�sultats -->
            <div>
               <a>title</a>
            </div>
            <span>test</span>
         ...
         <div class = "tooltips tooltipsbottom block" id="screen5" data-no="5,3,6" onclick="selectScreen(this)"> <!-- R�sultats des �l�ves par exercices -->
            <div>
               <a>title</a>
            </div>
            <span>test</span>
         ...
         <div class = "tooltips tooltipsbottom block" id="screen3" data-no="3,1,5" onclick="selectScreen(this)"> <!-- R�sultats d'un �l�ve, dat�s dans le temps // �valuation et Suivi Individuel -->
            <div>
               <a>title</a>
            </div>
            <span>test</span>
         ...
         <div class = "tooltips tooltipsbottom block" id="screen2" data-no="2,6,7" onclick="selectScreen(this)"><!-- Dernier exercice r�alis� par chaque �l�ve // Progressions R�parties -->
            <div>
               <a>title</a>
            </div>
            <span>test</span>
         ...
         <div class = "tooltips tooltipsbottom block" id="screen1" data-no="1,7,3" onclick="selectScreen(this)"> <!-- Progression G�n�rale - Bubble Chart -->
            <div>
               <a>title</a>
            </div>
            <span>test</span>
         ...
         <div class = "tooltips tooltipsbottom block" id="screen7" data-no="7,2,1" onclick="selectScreen(this)"><!-- Progression G�n�rale - Bar Chart -->
            <div>
               <a>title</a>
            </div>
            <span>test</span>
	 ...
	 <div class="tooltips headline" id="head4">Avanc�</div>

         <div class = "tooltips tooltipstop block" id="screen0" data-no="0,4,4" onclick="selectScreen(this)"> <!-- Nombre d'�l�ves par collecte -->
            <div>
               <a>title</a>
            </div>
            <span>test</span>
         ...
         <div class = "tooltips tooltipstop block" id="screen4" data-no="4,0,0" onclick="selectScreen(this)"> <!-- Nombre d'�l�ves par exercice selon leur p�riode d'inscription -->
            <div>
               <a>title</a>
            </div>
            <span>test</span>
