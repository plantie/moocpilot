...
var translations = {
	...
	'automaticCollectLabel-false': {'fr':"Collecte automatique : Active",
		'en':"automatic collection: active"},
	'collect': {'fr':"Collecte",
		'en':"Collect"},
  ...
  '#LO1':{'fr':"Progression Courante",'en':"General progression"},
  '#LO2':{'fr':"Progression selon la semaine d'inscription",'en':"Progression based on enrolment week"},
  '#LO3':{'fr':"Classement par semaine FUN",'en':"ordered by week of course"},
  '#LO4':{'fr':"Classement par type d'exercice",'en':"ordered by type of exercise"},
  '#LO5 a':{'fr':"Taille/Type Travaux",'en':"Size/Type work"},
