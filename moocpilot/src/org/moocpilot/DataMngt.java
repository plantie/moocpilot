...
public class DataMngt extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        MoocPilotLogger.LOGGER.log(Level.INFO, "DataMngt.doPost, action=" + action);
        ...
        if (action.equals("threadRemove")) {
            ...
            MoocPilotLogger.LOGGER.log(Level.INFO, "DataMngt.doPost, moocId=" + moocId + ", id=" + id);
    ...
    private static void unlockPermission(String scriptName, String contextPath) throws IOException {
        MoocPilotLogger.LOGGER.log(Level.INFO, "DataMngt.unlockPermission: " + contextPath + scriptName);
