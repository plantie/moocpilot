...
public class CsvList {
    ...
    public CsvList(String path) throws JsonSyntaxException, JsonIOException, FileNotFoundException {
        MoocPilotLogger.LOGGER.log(Level.INFO, "CsvList.CsvList, path=" + path);
        ...
        this.path = path;
//MoocPilotLogger.LOGGER.log(Level.INFO,"CsvList done " +path);
    }

    public void addCourse(String courseId) {
        MoocPilotLogger.LOGGER.log(Level.INFO, "CsvList.addCourse: " + courseId);
        this.listCourse.add(new Course(courseId));
    }

    public void addWeek(String courseId, int week, String weekName) {
        MoocPilotLogger.LOGGER.log(Level.INFO, "CsvList.addWeek: " + courseId);
