...
public class XlsTraitement {
	...
	/*
	    FileInputStream file = new FileInputStream(new File(path));
	      MoocPilotLogger.LOGGER.log(Level.INFO,"Time InputStream:"+ new Date().toString());

	    //Get the workbook instance for XLS file 
		this.workbook = new HSSFWorkbook(file);
	      MoocPilotLogger.LOGGER.log(Level.INFO,"Time SetWorkbook:"+ new Date().toString());

		this.sheetList = GetSheetIndexUtil();
	      MoocPilotLogger.LOGGER.log(Level.INFO,"Time GetSheetIndexUtil:"+ new Date().toString());

		this.tabHashtable = SetHashTable();
	      MoocPilotLogger.LOGGER.log(Level.INFO,"Time SetHashTable:"+ new Date().toString());

		this.tabEleveIndex = SetTabEleveIndex();
	      MoocPilotLogger.LOGGER.log(Level.INFO,"Time SetTabEleveIndex:"+ new Date().toString());

		this.listColumnName = SetListColumnName();
	      MoocPilotLogger.LOGGER.log(Level.INFO,"Time SetListColumnName:"+ new Date().toString());

		this.tabEleves = SetTabEleve();
	      MoocPilotLogger.LOGGER.log(Level.INFO,"Time SetTabEleve:"+ new Date().toString());
    ...
    public XlsTraitement(InputStream downloadedFile) {
        ...
        try {
            ...
            MoocPilotLogger.LOGGER.log(Level.INFO, e.toString());
