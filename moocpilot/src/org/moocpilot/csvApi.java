...
public class csvApi extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        MoocPilotLogger.LOGGER.log(Level.INFO, "csvApi doPost, moocId=" + moocId);
        ...
        MoocPilotLogger.LOGGER.log(Level.INFO, "csvApi doPost, idRequest=" + idRequest + ", idCsv=" + idCsv + ", csvListPath=" + csvListPath);
        ...
        switch (idRequest) {
            ...
            case 5:
                ...
                break;
            default:
                MoocPilotLogger.LOGGER.log(Level.INFO, "Bad Request");
        }
        csvList.save();
