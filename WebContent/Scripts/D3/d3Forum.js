...
function baseDisplay(){
	document.querySelector("#titleView a").innerHTML = "Forum (" + "<a href = 'https://www.fun-mooc.fr/courses/" + dataset[0].content.course_id + "/discussion/forum'>lien</a>" + ")" ;
...
function getPartDataset(weekNumber){
	...
	return dataset.filter(function(d){
		...
		return actualDate > partStart && actualDate < partEnd; 
	});
}
...
function actualiseTables(){
	...
	new_row.appendChild(new_cell_0);
	var new_cell_1 = document.createElement('th');
	new_cell_1.innerHTML = "Messages commentés";
	new_row.appendChild(new_cell_1);
	...
	new_row.appendChild(new_cell_0);
	var new_cell_1 = document.createElement('th');
	new_cell_1.innerHTML = "Messages orphelins";
	new_row.appendChild(new_cell_1);
	...
	for(var i = 1; i <= postOrdonnedOrphan.length; i++){
		...
		if(i-1 > postOrdonnedOrphan.length){
			...
			new_cell_1.onmouseover = function(){
				document.getElementById("tableOrphanHover").innerHTML = "\"" + postOrdonnedOrphan[this.pos].content.body + "\"" +"<span>" + postOrdonnedOrphan[this.pos].content.username + "</span>";
...
function actualisePersonPanel(personName, hierarchy, titleRelevant){
	...
	var new_cell_0 = document.createElement('th');
	new_cell_0.innerHTML = "Commentaires";
	new_row.appendChild(new_cell_0);
...
function actualisePostPanel(postId, scrollTo, needPersonUpdate){
	...
	var new_cell_0 = document.createElement('th');
	new_cell_0.innerHTML = "Réponses au message";
	new_row.appendChild(new_cell_0);
